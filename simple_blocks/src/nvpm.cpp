...
///////////////////////////////////////////////////////////////////////////
const char *
nvpm_resultToString(NVPMRESULT result)
{
  switch (result) {
    case NVPM_FAILURE_DISABLED:
      return "NVPM_FAILURE_DISABLED";
      break;
    case NVPM_FAILURE_32BIT_ON_64BIT:
      return "NVPM_FAILURE_32BIT_ON_64BIT";
      break;
    case NVPM_NO_IMPLEMENTATION:
      return "NVPM_NO_IMPLEMENTATION";
      break;
    case NVPM_LIBRARY_NOT_FOUND:
      return "NVPM_LIBRARY_NOT_FOUND";
      break;
    case NVPM_FAILURE:
      return "NVPM_FAILURE";
      break;
    ...
    case NVPM_ERROR_DRIVER_MISMATCH:
      return "NVPM_ERROR_DRIVER_MISMATCH";
      break;
    ...
    case NVPM_ERROR_BAD_ENUMERATOR:
      return "NVPM_ERROR_BAD_ENUMERATOR";
      break;
    ...
    case NVPM_ERROR_INVALID_OBJECT:
      return "NVPM_ERROR_INVALID_OBJECT";
      break;
    ...
    case NVPM_ERROR_EXPERIMENT_NOT_RUN:
      return "NVPM_ERROR_EXPERIMENT_NOT_RUN";
      break;
    case NVPM_ERROR_32BIT_ON_64BIT:
      return "NVPM_ERROR_32BIT_ON_64BIT";
      break;
    case NVPM_ERROR_STATE_MACHINE:
      return "NVPM_ERROR_STATE_MACHINE";
      break;
    case NVPM_ERROR_INTERNAL:
      return "NVPM_ERROR_INTERNAL";
      break;
    case NVPM_WARNING_ENDED_EARLY:
      return "NVPM_WARNING_ENDED_EARLY";
      break;
    case NVPM_ERROR_TIME_OUT:
      return "NVPM_ERROR_TIME_OUT";
      break;
    case NVPM_WARNING_DUPLICATE:
      return "NVPM_WARNING_DUPLICATE";
      break;
    case NVPM_ERROR_COUNTERS_ENABLED:
      return "NVPM_ERROR_COUNTERS_ENABLED";
      break;
    case NVPM_ERROR_CONTEXT_NOT_SUPPORTED:
      return "NVPM_ERROR_CONTEXT_NOT_SUPPORTED";
      break;
    case NVPM_ERROR_INVALID_CONTEXT:
      return "NVPM_ERROR_INVALID_CONTEXT";
      break;
    case NVPM_ERROR_GPU_UNSUPPORTED:
      return "NVPM_ERROR_GPU_UNSUPPORTED";
      break;
    case NVPM_INCORRECT_VALUE_TYPE:
      return "NVPM_INCORRECT_VALUE_TYPE";
      break;
    default:
      return "NVPM_ERROR_UNKNOWN";
      break;
  }
}
...
nvpm_init()
{
  ...
  if (nvResult!=NVPM_OK) {
    bd::Err() << "NvPmApi could not create context from ogl context! result: "
              << nvResult;
    return false;
  }
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_experimentFrameBegin(Mode *m)
{
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_experimentFrameEnd(Mode *mode)
{
  ...
  if (mode->isCollecting && mode->nPass>=mode->nTotalPasses) {
    std::cout << "Profiling completed after " << mode->nTotalPasses << " passes."
              << std::endl;
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_experimentWorkBegin(Mode *mode)
{
  if (mode->isCollecting) {
    glFinish();
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_experimentWorkEnd(Mode *mode)
{
  if (mode->isCollecting) {
    glFinish();
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_initMode(Mode *mode, NVPMContext perftext, bool perfMode = false)
{
  nvpm_resetMode(mode);
  ...
  for (size_t i = 0; i<g_experimentModeCounters.size(); ++i) {
    ...
    if (nvpmResult!=NVPM_OK) {
      ...
      bd::Err() << "AddCounterByName(" << counterName << ") returned " << std::setw(8)
                << std::hex << nvpmResult
                << "=>" << resultStr;
    }
  }
...
//////////////////////////////////////////////////////////////////////////
void
nvpm_printCounters(std::ostream &outStream,
                   Mode *mode) // NVPMContext perfCtx, const char ** const counterNames, int counterCount)
{
  outStream <<
  ...
  for (int i = 0; i<mode->counterCount; ++i) {
    ...
    /*NVPMCHECKCONTINUE(*/GetNvPmApi()
        ->GetCounterIDByContext(mode->perfCtx, mode->counterNames[i], &id); //);
    /*NVPMCHECKCONTINUE(*/GetNvPmApi()
        ->GetCounterAttribute(id, NVPMA_COUNTER_VALUE_TYPE, &type); //);
    ...
    if (type==NVPM_VALUE_TYPE_UINT64) {
      ...
      NVPMUINT64 value = 0;
      GetNvPmApi()
          ->GetCounterValueUint64(mode->perfCtx, id, 0, &value, &cycles, &overflow);
      ...
      NVPMFLOAT64 value = 0;
      GetNvPmApi()
          ->GetCounterValueFloat64(mode->perfCtx, id, 0, &value, &cycles, &overflow);
